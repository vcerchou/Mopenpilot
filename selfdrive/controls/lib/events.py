...
class NoEntryAlert(Alert):
  def __init__(self, alert_text_2: str,
               alert_text_1: str = _("MyPilot Unavailable"),
...
def calibration_incomplete_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  return Alert(
    _("Calibration in Progress: %(calPerc)d%%") % ({"calPerc": sm['liveCalibration'].calPerc}),
...
def traffic_assist_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  return Alert(
    _(sm['trafficAssist'].notifyMsg),
    "",
    AlertStatus.normal, AlertSize.small,
    Priority.HIGHEST, VisualAlert.none, AudibleAlert.speedLimit1, .1, .1, .1)
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.invalidLkasSetting: {
    ET.PERMANENT: NormalPermanentAlert(_("Stock LKAS is turned on"),
  ...
  EventName.calibrationInvalid: {
    ...
    ET.SOFT_DISABLE: soft_disable_alert(_("Calibration Invalid: Reposition Device and Recalibrate")),
  ...
  EventName.modeldLagging: {
    ...
    ET.NO_ENTRY: modeld_lagging_alert,
  },
  ...
  EventName.overcool: {
    ...
    ET.SOFT_DISABLE: SoftDisableAlert(_("System Overcooled")),
    ET.NO_ENTRY: NoEntryAlert(_("System Overcooled")),
  },
  ...
  EventName.timebombWarn: {
    ET.WARNING: Alert(
      ...
      AlertStatus.normal, AlertSize.mid,
      Priority.LOW, VisualAlert.steerRequired, AudibleAlert.warningSoft, .4, 2., 3.),
  },
  ...
  EventName.timebombBypassed: {
    ET.WARNING: Alert(
      ...
      AlertStatus.normal, AlertSize.mid,
      Priority.LOW, VisualAlert.steerRequired, AudibleAlert.warningSoft, 3., 2., 3.),
  },

  EventName.inSpeedLimitArea: {
    ET.PERMANENT: traffic_assist_alert,
  },

  EventName.outSpeedLimitArea: {
    ET.PERMANENT: Alert(
      "",
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.HIGHEST, VisualAlert.none, AudibleAlert.speedLimit2, .1, .1, .1),
  },
  # mp end
}
