...
public:
  ...
  static void launch_locale() {
    launch_activity("com.android.settings/.Settings\\$LocalePickerActivity", "-a android.settings.LOCALE_SETTINGS");
  }
  static void launch_sound() {
    launch_activity("com.android.settings/.Settings\\$SoundSettingsActivity", "-a android.settings.SOUND_SETTINGS");
  }
  static std::string get_serial() {
    std::string cmd = "getprop ro.serialno";
    return util::get_cmd(cmd);
  }
  static std::string get_lang(){
    return util::read_file("/data/property/persist.sys.locale");
  }
  // mp end
};
