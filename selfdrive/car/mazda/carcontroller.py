...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    self.ti_apply_steer_last = 0  # mp add
  ...
  def update(self, c, CS, frame):
    ...
    apply_steer = 0
    ti_apply_steer = ti_new_steer = 0  # mp add
    self.steer_rate_limited = False
    ...
    if c.latActive:
      ...
      self.steer_rate_limited = (new_steer != apply_steer) and (ti_new_steer != ti_apply_steer) # mp update
