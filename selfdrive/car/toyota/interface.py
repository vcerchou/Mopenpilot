...
#mp gas smoothly
ACCEL_MAX_BP=[0., 8., 12., 20., 27.]
ACCEL_MAX_V=[1.8, 1.8, 0.9, 0.38, 0.30]

class CarInterface(CarInterfaceBase):
  # mp update
  @staticmethod
  def get_pid_accel_limits(CP, current_speed, cruise_speed):
    max = interp(current_speed, ACCEL_MAX_BP, ACCEL_MAX_V)
    return CarControllerParams.ACCEL_MIN, max
