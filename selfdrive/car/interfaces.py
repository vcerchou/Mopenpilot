...
class CarInterfaceBase(ABC):
  ...
  def get_std_params(candidate, fingerprint):
    ...
    # mp_lc
    steeringTorqueMod = Params().get("SteeringTorqueMod")
    ret.steeringTorqueMod = 0 if steeringTorqueMod is None else int(steeringTorqueMod)
    print("CP.steeringTorqueMod=%s" % ret.steeringTorqueMod)
    # mp end
    ...
    ret.enableTorqueInterceptor = False  # mp add TI
    return ret
