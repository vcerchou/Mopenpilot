...
from selfdrive.car.volkswagen.values import DBC_FILES, CANBUS, MQB_LDW_MESSAGES, BUTTON_STATES, CarControllerParams as P, NetworkLocation
...
class CarController():
  ...
  def update(self, c, CS, frame, ext_bus, actuators, visual_alert, left_lane_visible, right_lane_visible, left_lane_depart, right_lane_depart):
    ...
    if frame % P.LDW_STEP == 0:
      ...
      can_sends.append(self.create_hud_control(self.packer_pt, CANBUS.pt, c.enabled,
