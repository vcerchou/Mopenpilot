...
class CAR:
  ...
  # mp add
  CUSTOM = "HONDA ODYSSEY/ELYSION CUSTOM"
...
DBC = {
  ...
  CAR.CUSTOM: dbc_dict('honda_odyssey_extreme_edition_2018_china_can_generated', 'acura_ilx_2016_nidec'),
  ...
  CAR.URV: dbc_dict('honda_urv_can_generated', 'acura_ilx_2016_nidec'),
}
...
HONDA_NIDEC_ALT_SCM_MESSAGES = {CAR.ACURA_ILX, CAR.ACURA_RDX, CAR.CRV, CAR.CRV_EU, CAR.FIT, CAR.FREED, CAR.HRV, CAR.ODYSSEY_CHN,
                                CAR.PILOT, CAR.PASSPORT, CAR.RIDGELINE, CAR.JADE, CAR.CUSTOM}
...
HONDA_COMPATIBILITY = {CAR.CUSTOM, CAR.CLARITY, CAR.JADE, CAR.URV}
