...
from selfdrive.car.hyundai.values import DBC, STEER_THRESHOLD, FEATURES, EV_CAR, HYBRID_CAR, CAR, Buttons
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    # mp add
    if self.CP.carFingerprint != CAR.ENCINO_EV:
  ...
  def get_can_parser(CP):
    ...
    if CP.carFingerprint != CAR.ENCINO_EV:  # mp add
      signals += [
        ("YAW_RATE", "ESP12", 0),
        ("CYL_PRES", "ESP12", 0),
      ]
    ...
    if CP.carFingerprint in (CAR.ENCINO_EV, ):
