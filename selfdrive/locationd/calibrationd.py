...
is_mp_auth = Params().get_bool("IsMpAuth")
if is_mp_auth:
  PITCH_LIMITS = np.array([-0.19074112085129739, 0.24907572052989657])
  YAW_LIMITS = np.array([-0.09912048084718224, 0.09912048084718235])
