...
const uint32_t TOYOTA_EPS_FACTOR =  255; //(1U << TOYOTA_PARAM_OFFSET) - 1U;
const uint32_t TOYOTA_PARAM_ALT_BRAKE = 256; //1U << TOYOTA_PARAM_OFFSET;
const uint32_t TOYOTA_PARAM_STOCK_LONGITUDINAL = 512; //2U << TOYOTA_PARAM_OFFSET;
